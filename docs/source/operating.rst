[cybersecuritywithprivategpt-7042] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-7042] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-7042] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/hardikdagar7/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=34777  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='hardikdagar7'  \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env MQTTUSERNAME='hardikdagar0207'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hardikdagar0207/cybersecuritywithprivategpt-7042-amd64 (https://hub.docker.com/r/hardikdagar0207/cybersecuritywithprivategpt-7042-amd64)
...
.. code-block::
   ...
   docker run -d -p 38503:38503 -p 48541:48541 -p 54081:54081 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=cybersecuritywithprivategpt-7042 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-7042 \
          --env GITUSERNAME=hardikdagar7 \
          --env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=38503 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=48541  \
          --env SOLUTIONVIPERVIZPORT=54081 \
          ...
          hardikdagar0207/cybersecuritywithprivategpt-7042-amd64
...
[cybersecuritywithprivategpt-7042] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/hardikdagar7/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-7042
...
.. important::
   https://cybersecuritywithprivategpt-7042.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-7042
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=38503, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39755, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35729, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=37363, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40347, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33557, HPDEHOST=127.0.1.1, HPDEPORT=38259, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36203

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2674-cybersecuritywithprivategpt-7042,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-7042, python-preprocess-1917-cybersecuritywithprivategpt-7042,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-7042, python-ai-9799-cybersecuritywithprivategpt-7042,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-7042, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
